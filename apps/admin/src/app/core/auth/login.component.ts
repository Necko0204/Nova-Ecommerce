    ...
    <main class="admin-login">
      ...
      <section class="admin-login__form-wrap">
        <form [formGroup]="form" (ngSubmit)="submit()">
          ...
          @if (!auth.isConfigured) { <div class="demo-credentials"><strong>Local demo access</strong><span>admin&#64;novasupply.local</span><span>NovaDemo!2026</span></div> }
...
export class LoginComponent {
  ...
  readonly form = this.fb.nonNullable.group({ email: ['admin@novasupply.local', [Validators.required, Validators.email]], password: ['NovaDemo!2026', [Validators.required, Validators.minLength(8)]] });
